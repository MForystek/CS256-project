...
#
# Generated by export_simulation on Thu Nov 30 11:23:20 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './background_sprite.sh' script.

./background_sprite.sh -reset_run
...
./background_sprite.sh -noclean_files

For more information on the script, please type './background_sprite.sh -help'.
