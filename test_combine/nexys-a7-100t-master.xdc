...
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { in_red[3] }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { in_green[3] }]; #IO_L5N_T0_D07_14 Sch=sw[7]
...
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { in_blue[3] }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
